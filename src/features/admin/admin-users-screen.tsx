...
const styles = StyleSheet.create({
  ...
  card: { borderRadius: 16, borderWidth: 1, elevation: 3, marginBottom: 12, padding: 14, shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 14 },
  ...
  action: { borderRadius: 10, paddingHorizontal: 12, paddingVertical: 9 },
